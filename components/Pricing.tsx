...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            {t.pricing.title}{' '}
            <span className="text-green-400">{t.pricing.freeAccess}</span>
            {' '}{t.pricing.forEveryone}
          </h2>
        </div>

        <div className="max-w-2xl mx-auto">
          <div className="relative bg-white/10 backdrop-blur-sm p-10 rounded-3xl border-2 border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300">
            {/* Badge */}
            ...
            <div className="text-center mb-8 mt-4">
              <h3 className="text-3xl font-bold text-white mb-4">{t.pricing.planTitle}</h3>
              <div className="text-6xl font-bold text-white mb-2">{t.pricing.price}</div>
            ...
            <ul className="space-y-4 mb-10">
              {features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3 group">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-green-400/20 flex items-center justify-center group-hover:bg-green-400/30 transition">
        ...
        <div className="text-center mt-12">
          <p className="text-blue-200">
            {t.pricing.contact}{' '}
            <a href="mailto:support@citea.com" className="text-blue-300 hover:text-blue-200 hover:underline font-medium">
              support@citea.com
            </a>
          </p>
        </div>
