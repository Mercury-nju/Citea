      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Link href="/auth/signin" className="group block">
            <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-100 overflow-hidden hover:shadow-2xl hover:border-lime-300 transition-all duration-300">
              {/* 真实Dashboard截图预览 */}
              <div className="aspect-[4/3] bg-gradient-to-br from-lime-50 to-lime-100 relative overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <div className="w-full h-full p-4">
                    ...
                    <div className="space-y-2">
                      <div className="bg-white rounded-lg border-2 border-lime-300 p-2">
                        <div className="h-3 bg-lime-100 rounded w-3/4 mb-1"></div>
                ...
                {/* 播放图标覆盖层 */}
                <div className="absolute inset-0 bg-lime-600/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="w-16 h-16 bg-lime-600 rounded-full flex items-center justify-center shadow-xl">
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <span className="inline-flex items-center gap-1 bg-lime-50 text-lime-700 px-2 py-1 rounded-full text-xs font-semibold mt-1">
