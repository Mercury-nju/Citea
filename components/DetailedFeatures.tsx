      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Link href="/auth/signin" className="group block">
            <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-100 overflow-hidden hover:shadow-2xl hover:border-amber-300 transition-all duration-300">
              {/* 真实Dashboard截图预览 */}
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <div className="w-full h-full p-4">
                    ...
                    <div className="space-y-2">
                      <div className="bg-white rounded-lg border-2 border-amber-300 p-2">
                        <div className="h-3 bg-amber-100 rounded w-3/4 mb-1"></div>
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <span className="inline-flex items-center gap-1 bg-amber-50 text-amber-700 px-2 py-1 rounded-full text-xs font-semibold mt-1">
