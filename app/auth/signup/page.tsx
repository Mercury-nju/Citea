        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-gray-500">{t.auth.signUp.orSignUpWith}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
              ...
              <span className="text-sm font-medium text-gray-700">{t.auth.signUp.google}</span>
            </button>
            <button className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
              ...
              <span className="text-sm font-medium text-gray-700">{t.auth.signUp.github}</span>
            </button>
          </div>
